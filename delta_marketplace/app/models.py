...
"""
Not sure if we're allowed to use these because:
    "API calls in lieu of SQL queries and non-SQL query languages are forbidden unless they are used only incidentally."
"""
